    ...
    <div>
      <section className="section-block section-block--white page-section--tight">
        <div className="page-shell">
          <div className="hero-panel hero-panel--narrow hero-grid narrow-reading-width">
            <span className="eyebrow">소개</span>
            <h1 className="page-title">발달지연 자녀를 둔 부모가 오늘 바로 써볼 수 있는 ABA 가이드를 만듭니다.</h1>
            <p className="page-description">
              ABA 개념을 어렵게 풀지 않고, 집에서 바로 시도할 수 있는 문장과 흐름으로 바꾸는 것이 이 서비스의 출발점입니다.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="section-band section-band--soft">
            <div className="grid gap-5 md:grid-cols-2">
              <article className="support-panel">
                <span className="eyebrow">만든 이유</span>
                <h2 className="section-title mt-3 text-[1.25rem]">왜 이 서비스를 만들었나요</h2>
              ...
              <article className="support-panel">
                ...
                <h2 className="section-title mt-3 text-[1.25rem]">운영 원칙</h2>
      ...
      <section className="section-block section-block--gray page-section">
        <div className="page-shell">
          <div className="section-band">
            <article className="support-panel max-w-[760px]">
              <span className="eyebrow">문의</span>
              <h2 className="section-title mt-3 text-[1.25rem]">문의</h2>
